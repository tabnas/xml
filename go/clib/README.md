...
tabnas port can parse and validate xml input. This is one of the
...
| Function | Returns |
|---|---|
| `tabnas_version()` | `{"ok":true,"lib":"libtabnasxml","format":"xml","template":"v1"}` |
...
// link against libtabnasxml; every call returns a JSON []u8 to free with
// c.tabnas_free.
```
